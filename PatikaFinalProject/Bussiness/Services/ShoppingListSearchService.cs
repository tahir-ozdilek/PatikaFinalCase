...
namespace PatikaFinalCase.Bussiness.Services
{
    public class ShoppingListSearchService
    {
        ...
        public async Task<Response<List<ShoppingListDTO>>> SearchByCategory(string categoryName)
        {
        ...
        public async Task<Response<List<ShoppingListDTO>>> SearchByListName(string categoryName)
        {
        ...
        public async Task<Response<List<ShoppingListDTO>>> FindShoppingListsWithCreationDateAfterThan(DateTime date)
        {
        ...
        public async Task<Response<List<ShoppingListDTO>>> FindShoppingListsWithCreationDateBeforeThan(DateTime date)
        {
            List<ShoppingList> shoppingList = await dbContext.Set<ShoppingList>().Where(t => t.CreationDate < date).Include(y => y.Category).Include(x => x.ProductList).ToListAsync();
        ...
        public async Task<Response<List<ShoppingListDTO>>> FindShoppingListsWithCompletionDateAfterThan(DateTime date)
        {
        ...
        public async Task<Response<List<ShoppingListDTO>>> FindShoppingListsWithCompletionDateBeforeThan(DateTime date)
        {
            List<ShoppingList> shoppingList = await dbContext.Set<ShoppingList>().Where(t => t.CompletedDate < date).Include(y => y.Category).Include(x => x.ProductList).ToListAsync();
