...
namespace PatikaFinalProject.Bussiness.Services
{
    public class ShoppingListService
    {
        ...
        {
                List<ShoppingList> shoppingList = await dbContext.Set<ShoppingList>().Include(y => y.Category).Where(y=> y.Category.Name == categoryName).Include(x => x.ProductList).ToListAsync();
